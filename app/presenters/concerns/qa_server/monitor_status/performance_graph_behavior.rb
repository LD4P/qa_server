...
module QaServer::MonitorStatus
  module PerformanceGraphBehavior
    ...
    def performance_for_day_graph
      ...
      QaServer::PerformanceGraphingService.performance_graph_file(authority_name: ALL_AUTH, time_period: :day)
    end
    ...
    def performance_for_month_graph
      ...
      QaServer::PerformanceGraphingService.performance_graph_file(authority_name: ALL_AUTH, time_period: :month)
    end
    ...
    def performance_for_year_graph
      ...
      QaServer::PerformanceGraphingService.performance_graph_file(authority_name: ALL_AUTH, time_period: :year)
    end
    ...
    #     graph_service.performance_graph_file(authority_name: ALL_AUTH, time_period: :day)
