    ...
    class << self
      ...
      def average_last_24_hours
        ...
        0.upto(23).each do |idx|
          records = performance_data_class.where(dt_stamp: start_hour..start_hour.end_of_hour)
          stats = stats_calculator_class.calculate_stats(records)
          data = {}
      ...
      def average_last_30_days
        ...
        0.upto(29).each do |idx|
          records = performance_data_class.where(dt_stamp: start_day..start_day.end_of_day)
          stats = stats_calculator_class.calculate_stats(records)
          data = {}
      ...
      def average_last_12_months
        ...
        0.upto(11).each do |idx|
          records = performance_data_class.where(dt_stamp: start_month..start_month.end_of_month)
          stats = stats_calculator_class.calculate_stats(records)
          data = {}
